        ...
        <transition name="slide-fade">
          <section class="showChose" v-show="showChose">
            <section class="address">
              ...
              <section class="title">
                <div class="area" ref="content1" @click="provinceSelected()">{{Province?Province:info[province-1].name}}</div>
                <div class="area" ref="content2" @click="citySelected()" :class="City?'':'active'">{{City?City:'请选择'}}</div>
                <div class="area" ref="content3" @click="districtSelected()" :class="District?'':'active'" v-show="City">{{District?District:'请选择'}}</div>
              </section>
              <ul>
      ...
      methods:{
        ...
        save(){
          if(this.Consignee !== "" && this.phone !== "" && this.address !== ""){
            ...
            axios.post('http://192.168.5.183:8080/address', postData)
              .then(response => {
...
<style scoped lang="less">
  ...
  .slide-fade-enter-active{//boom 是过渡名称 in,out是两个动画，动画写到进入和离开结束的class中
    animation:in .5s;
  }
